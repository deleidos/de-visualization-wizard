...
class RawHelper(object):
    ...
    def get_parsing_candidate(self, url, raw_html):
        # print("goose: crawler: utils: RawHelper : get_parsing_candidate: raw_html: ", raw_html)
        # if isinstance(raw_html, unicode):
        #     raw_html = raw_html.encode('utf-8')
        link_hash = '%s.%s' % (hashlib.md5(raw_html.encode('utf-8')).hexdigest(), time.time())
...
class URLHelper(object):
    ...
    def get_parsing_candidate(self, url_to_crawl):
        ...
        # print("goose: crawler: utils: URLHelper : get_parsing_candidate: final_url: ", final_url)
        ...
        # print("goose: crawler: utils: URLHelper : get_parsing_candidate: link_hash: ", link_hash)
